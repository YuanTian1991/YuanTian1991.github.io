            ...
            // <Link key={index} to={node.frontmatter.slug} style={{ textDecoration: "none", }}>
              ...
              >
                <Box my={1}>
                  ...
                  <Typography  style={{ fontSize: '0.85em', color: 'grey', padding: '10px 0px 0px 0px'}}>
...

                    {
                      node.frontmatter.tags.map((tag, tagIndex) => {
                        return (
                          ...
                          style={{zIndex: 9999,margin: '0px 5px 3px 5px', fontSize: '14.5px', backgroundColor: selectedTag.includes(tag) ? "hsla(0,0%,0%,0.8)": "white"}} 
                          onClick={(e) => {
                            e.stopPropagation(); 
                            handleSelectTag(tag)
                    }}
        ...
        <Grid item xs={3}>
          {
            tagCount.map((tag, index) => {
              return(
                ...
                style={{margin: '5px', fontSize: '14.5px', backgroundColor: selectedTag.includes(tag.tag) ? "hsla(0,0%,0%,0.8)": "white"}} 
