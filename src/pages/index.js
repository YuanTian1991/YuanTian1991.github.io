        ...
        <Grid item xs={12} md={9}>
          {props.data.allMarkdownRemark.edges.map(({ node }, index) => {
            if (
              ...
              selectedTag.some(r => node.frontmatter.tags.indexOf(r) >= 0)
            ) {
              return (
                ...
                >
                  <Box my={1}>
                    <h2
                      style={{ marginBottom: "0.1em", marginTop: "0" }}
                              ...
                              <code
                                className={
                                  selectedTag.includes(tag)
                                    ? classes.sideChipLabelActive
                                    : classes.sideChipLabel
                                }
                                // style={}
                              >
                                {tag}
            ...
            return (
              <Chip
                ...
                style={{
                  margin: "5px",
                  fontSize: "14.5px",
                  backgroundColor: selectedTag.includes(tag.tag)
                    ? "hsla(0,0%,0%,0.8)"
                    : "white",
                }}
